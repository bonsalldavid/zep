...
#    mv /app/zep.yaml /app/zep.yaml.template
    ...
    envsubst '$ZEP_AUTH_SECRET $POSTGRES_USER $POSTGRES_PASSWORD $POSTGRES_HOST $POSTGRES_PORT $POSTGRES_DATABASE $ZEP_API_SECRET $ZEP_SERVER_WEB_ENABLED $ZEP_OPENAI_API_KEY $GRAPHITI_HOSTPORT' \
